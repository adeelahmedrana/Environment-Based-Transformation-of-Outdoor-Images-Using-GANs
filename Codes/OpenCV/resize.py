...
input_image = hd_path_output ="C:/Users/adeel/OneDrive/Desktop/TUI/Project/Datasets/SEASONS/train/summer/*.jpg"
...
# resize image
    ...
    cv2.imwrite(orignal_output +str(os.path.basename(h)), resized)
    #cv2.imwrite(output_rain +str(os.path.basename(h)), right_half)
    print('done' + image_num)
